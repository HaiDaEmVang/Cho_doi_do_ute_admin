...
const SignIn: React.FC = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://cho-doi-do-ute-server.onrender.com/api/auth/login", {
        method: "POST",
        headers: {
      ...
      if (!response.ok) {
        ...
        throw new Error(message.error || "Invalid email or password");
      }
          ...
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="py-17.5 px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
                <img className="hidden dark:block max-w-20" src={Logo} alt="Logo" />
                <img className="dark:hidden" src={LogoDark} alt="Logo" />
              </Link>

              <p className="2xl:px-20">
                Đăng nhập để quản lý hệ thống chợ đổi đồ UTE
              </p>
